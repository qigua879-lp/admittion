...
OUT_DIR="${ROOT_DIR}/sim/logs/regression"
SIM="${SIM:-auto}"
...
SIM_TOOL="$(detect_sim)"
echo "INFO: regression simulator=${SIM_TOOL}"
...
run_sv_test "tb_frame_line_sync"        "tb_frame_line_sync"        "tb/tests/tb_frame_line_sync.sv"
run_sv_test "tb_lane_deskew_buffer"     "tb_lane_deskew_buffer"     "tb/tests/tb_lane_deskew_buffer.sv"
...
run_sv_test "tb_raw10_unpack"           "tb_raw10_unpack"           "tb/tests/tb_raw10_unpack.sv"
run_sv_test "tb_yuv422_unpack"          "tb_yuv422_unpack"          "tb/tests/tb_yuv422_unpack.sv"

run_sv_test "tb_err_classifier"         "tb_err_classifier"         "tb/tests/tb_err_classifier.sv"
run_sv_test "tb_err_logger"             "tb_err_logger"             "tb/tests/tb_err_logger.sv"
run_sv_test "tb_resync_ctrl"            "tb_resync_ctrl"            "tb/tests/tb_resync_ctrl.sv"

run_sv_test "tb_addr_gen_frame_based"   "tb_addr_gen_frame_based"   "tb/tests/tb_addr_gen_frame_based.sv"
...
run_sv_test "tb_brightness_adjust"      "tb_brightness_adjust"      "tb/tests/tb_brightness_adjust.sv"
run_sv_test "tb_contrast_adjust"        "tb_contrast_adjust"        "tb/tests/tb_contrast_adjust.sv"
run_sv_test "tb_gray_balance"           "tb_gray_balance"           "tb/tests/tb_gray_balance.sv"
...
compile_only "preprocess_bypass_mux"   "preprocess_bypass_mux"
compile_only "mipi_csi2_capture_top"   "mipi_csi2_capture_top"

echo "PASS: full regression completed. Logs: ${OUT_DIR}"

# Vivado synthesis-only runner.
#
# Usage:
#   vivado -mode batch -source 02_vivado_project_and_sim/vivado/run_synth_only.tcl \
...
puts "INFO: Starting synthesis-only run."
clear_windows_readonly_dir [file dirname $project_file]
reset_run synth_1
...
puts "INFO: Synthesis-only reports written to $report_root"
puts "INFO: Synthesis-only run completed."

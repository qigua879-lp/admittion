# Vivado synthesis / implementation runner that stops after routing and reports.
#
# Usage:
#   vivado -mode batch -source 02_vivado_project_and_sim/vivado/run_impl_route_only.tcl \
...
puts "INFO: Starting implementation through route_design."
reset_run impl_1
...
puts "INFO: Route-level reports written to $report_root"
close_project
